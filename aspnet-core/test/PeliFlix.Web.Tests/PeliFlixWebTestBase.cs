...
{
    public abstract class PeliFlixWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PeliFlixWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PeliFlixWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PeliFlixDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PeliFlixDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PeliFlixDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PeliFlixDbContext, Task<T>> func)
        {
            T result;
