...
export class GenderServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateGenderDto | undefined): Observable<GenderDto> {
        let url_ = this.baseUrl + "/api/services/app/Gender/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<GenderDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GenderDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    update(body: GenderDto | undefined): Observable<GenderDto> {
        let url_ = this.baseUrl + "/api/services/app/Gender/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<GenderDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Gender/Delete?";
        if (id === null)
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<GenderDto> {
        let url_ = this.baseUrl + "/api/services/app/Gender/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<GenderDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GenderDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Gender/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GenderDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GenderDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<GenderDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GenderDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GenderDtoPagedResultDto>(<any>null);
    }
}
...
export class MovieServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateMovieDto | undefined): Observable<MovieDto> {
        let url_ = this.baseUrl + "/api/services/app/Movie/Create";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<MovieDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<MovieDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<MovieDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<MovieDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(body: MovieDto | undefined): Observable<MovieDto> {
        let url_ = this.baseUrl + "/api/services/app/Movie/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<MovieDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Movie/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getGenders(): Observable<GenderDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Movie/GetGenders";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GenderDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GenderDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetGenders(response: HttpResponseBase): Observable<GenderDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GenderDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GenderDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<MovieDto> {
        let url_ = this.baseUrl + "/api/services/app/Movie/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<MovieDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<MovieDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<MovieDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<MovieDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MovieDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<MovieDtoPagedResultDto>(<any>null);
    }
}

@Injectable()
export class MovieSeenServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateMovie_SeenDto | undefined): Observable<Movie_SeenDto> {
        let url_ = this.baseUrl + "/api/services/app/MovieSeen/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<Movie_SeenDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: Movie_SeenDto | undefined): Observable<Movie_SeenDto> {
        let url_ = this.baseUrl + "/api/services/app/MovieSeen/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<Movie_SeenDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/MovieSeen/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<Movie_SeenDto> {
        let url_ = this.baseUrl + "/api/services/app/MovieSeen/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<Movie_SeenDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<Movie_SeenDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/MovieSeen/GetAll?";
        if (keyword !== undefined && keyword !== null)
            url_ += "keyword=" + encodeURIComponent("" + keyword) + "&";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<Movie_SeenDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<Movie_SeenDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<Movie_SeenDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = Movie_SeenDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<Movie_SeenDtoPagedResultDto>(<any>null);
    }
}
...
export class CreateGenderDto implements ICreateGenderDto {
    name: string;

    constructor(data?: ICreateGenderDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateGenderDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateGenderDto();
        result.init(data);
        return result;
    }
...
export interface ICreateGenderDto {
    name: string;
}
...
export class GenderDtoPagedResultDto implements IGenderDtoPagedResultDto {
    totalCount: number;
    items: GenderDto[] | undefined;

    constructor(data?: IGenderDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GenderDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): GenderDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GenderDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IGenderDtoPagedResultDto {
    totalCount: number;
    items: GenderDto[] | undefined;
}
...
export class GenderDtoListResultDto implements IGenderDtoListResultDto {
    items: GenderDto[] | undefined;

    constructor(data?: IGenderDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GenderDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GenderDtoListResultDto();
        result.init(data);
        return result;
    }
...
export interface IGenderDtoListResultDto {
    items: GenderDto[] | undefined;
}

export class MovieDtoPagedResultDto implements IMovieDtoPagedResultDto {
    totalCount: number;
    items: MovieDto[] | undefined;

    constructor(data?: IMovieDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MovieDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new MovieDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IMovieDtoPagedResultDto {
    totalCount: number;
    items: MovieDto[] | undefined;
}

export class CreateMovie_SeenDto implements ICreateMovie_SeenDto {
    view: boolean;
    ...
    constructor(data?: ICreateMovie_SeenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateMovie_SeenDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateMovie_SeenDto();
        result.init(data);
        return result;
    }
...
export interface ICreateMovie_SeenDto {
    view: boolean;
    viewDate: moment.Moment;
    score: number;
    movieId: number;
...
export class Movie_SeenDto implements IMovie_SeenDto {
    view: boolean;
    viewDate: moment.Moment;
    score: number;
    movieId: number;
    ...
    static fromJS(data: any): Movie_SeenDto {
        data = typeof data === 'object' ? data : {};
        let result = new Movie_SeenDto();
        result.init(data);
        return result;
    }
...
export interface IMovie_SeenDto {
    view: boolean;
    viewDate: moment.Moment;
    score: number;
    movieId: number;
...
export class Movie_SeenDtoPagedResultDto implements IMovie_SeenDtoPagedResultDto {
    ...
    constructor(data?: IMovie_SeenDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Movie_SeenDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new Movie_SeenDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): Movie_SeenDtoPagedResultDto {
        const json = this.toJSON();
        let result = new Movie_SeenDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IMovie_SeenDtoPagedResultDto {
    totalCount: number;
    items: Movie_SeenDto[] | undefined;
}
