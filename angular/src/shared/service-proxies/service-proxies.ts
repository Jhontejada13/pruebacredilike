...
export class MovieServiceProxy {
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<MovieDtoPagedResultDto> {
     ...
     * @return Success
     */
    create(body: MovieDto | undefined): Observable<MovieDto> {
